...
sets = ['GR95C', 'KR87B', 'KR87M', 'BR90', 'GR95', 'Leo06']
is_cross = [False, False, False, True, True, True]
is_total = [True, False, False, False, True, False]
is_percent = [False, False, False, True, False, False]
raw_dir = 'data/ddtp_raw/'
output_dir = 'data/ddtp/'
